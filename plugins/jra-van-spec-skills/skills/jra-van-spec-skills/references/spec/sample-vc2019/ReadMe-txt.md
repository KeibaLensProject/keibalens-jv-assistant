...
出典: `context/sample1_VC2019/ReadMe.txt`

プロジェクト構成の概要(AppWizard 生成)

```text
========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : sample1
========================================================================


AppWizard が生成した sample1 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには sample1 を構成している各ファイルの概要説明が含まれています。
...
sample1.h
    ...
    みます） をインクルードし、また CSample1App アプリケーションクラスを宣
    言します。

sample1.cpp
    このファイルは CSample1App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\sample1.ico
    ...
    ルです。このアイコンはリソース ファイル sample1.rc によってインクルード
    されます。
...
sample1Dlg1.h, sample1Dlg1.cpp - ダイアログ
    これらのファイルは CSample1Dlg1 クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な sample1.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) sample1.pch 
